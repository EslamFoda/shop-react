  ...
  return (
    <div className="main-container discover-container">
      ...
      <div className="organic-header">
        <img
          src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/heading-png_180x.png?v=1592814960"
          alt=""
        />
                ...
                <div className="deal-img-container">
                  <div className="overview">
                    <div className="btn-container">
                      ...
                      <button
                        className="deal-btn sec-deal-btn"
                        onClick={() => {
                          let getItem = null;
                          projectFirestore
                            .collection("all")
                  ...
                  <div className="overview-media">
                    <span
                      className="material-icons-outlined visibility-icon-media"
                      onClick={() =>
                        projectFirestore
                          .collection("all")
                          .doc(item.id)
                    ...
                    <span
                      className="material-icons-outlined shop-icon-media"
                      onClick={() => {
                        let getItem = null;
                        projectFirestore
                          .collection("all")
      ...
      <AnimatePresence>
        {openModel && (
          <motion.div className="model-overlay" exit={{ opacity: 0 }}>
            <motion.div
            ...
            >
              <span
                className="material-icons-outlined close-model"
              ...
              <div className="model-grid">
                ...
                <div className="right-model">
                  <div className="product-details">
                    <h1 className="deal-title product-title">
                      {product.title}
                    </h1>
                    <div>
                      <h3 className="deal-title product-price">
                        ${product.price}.00
                      </h3>
                    </div>
                    <p>
                      This beautifully coloured jam uses the best blueberries to
                      achieve a full, fruity flavour. Ingredients: Sugar,
                      Blueberries, Pectin, Citric Acid, Sodium Citrate. Organic
                      food is food produced by methods that comply with...
                    </p>
                  </div>
                  <div className="add-container-wrapper">
                    <div className="add-container">
                      <div className="quantity-container">
                        <div className="quantity-flex">
                          <span
                            className="material-icons-outlined quantity-icons"
                            onClick={() => {
                              if (count > 1) {
                                setCount(count - 1);
                              }
                      ...
                      <span className="material-icons-outlined quantity-fav">
                        favorite_border
                      </span>
                    </div>
                    ...
                    <p className="product-order">
                      Order in the next 0 hours 59 minutes to get it by
                      Wednesday 15 July, 2020
                    </p>
                    <div className="guranteed">
                      <img
                        src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/PROD1_500x_b7e7d1ea-7d34-4184-9e02-85bd20c991d9_480x.png?v=1593504046"
                        alt=""
                      />
                    </div>
                  </div>
