    ...
    <div>
      ...
      <nav>
        <div className="nav-links">
          <img
            src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/kalles_2x_a389d494-6b66-41e9-91dd-9f1b90710be6_140x.png?v=1591951678"
            alt=""
          />
          <Link to="/">Home</Link>
          <span style={{ cursor: "pointer" }}>Shop</span>
          <span className="blog-icon" style={{ cursor: "pointer" }}>
            Blog
          </span>
        </div>
