    ...
    return ( 
        <div className='main-container'>
            <div className='organic-header'>
                <img src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/icon_180x.png?v=1592648805" alt="" />
            ...
            <div className='organic-grid'>
                <div className='organic-box'>
                    <div className='organic-img-container'>
                        ...
                        <img src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/banner1_360x.png?v=1592648680" alt="" />
                        </div>
                        <h2>WHO WE ARE?</h2>
                ...
                <div className='organic-box'>
                    <div className='organic-img-container'>
                        <div className='organic-img-wrapper'>
                        <img src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/banner-2_360x.png?v=1592648680" alt="" />
                        </div>
                        <h2>HOW WE WORK?</h2>
                        <p>We believe it’s the best way to inspire our community to relish in the taste of real, seasonal produce and keep connected to the land.</p>
                        <button className='organic-btn'>Read More</button>
                    </div>
                ...
                <div className='organic-box'>
                    <div className='organic-img-container'>
                        <div className='organic-img-wrapper'>
                        <img src="https://cdn.shopify.com/s/files/1/0270/2098/4401/files/banner-3_360x.png?v=1592648679" alt="" />
                        </div>
                        <h2>WHAT WE GROW?</h2>
