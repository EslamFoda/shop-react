...
const Tabs = () => {
  ...
  return (
    <div className="tabs-section">
      <div className="tabv2">
        <button
          className="tabv2links active"
          onClick={(e) => {
            openCity(e, "Description");
          }}
        >
          Description
        </button>
        <button
          className="tabv2links"
          onClick={(e) => {
            openCity(e, "Custom");
          }}
        >
      ...
      <div id="Description" className="tabv2content active-tabv2">
        <p>
          This beautifully coloured jam uses the best blueberries to achieve a
          full, fruity flavour. Ingredients: Sugar, Blueberries, Pectin, Citric
          Acid, Sodium Citrate. Organic food is food produced by methods that
          comply with the standards of organic farming.
        </p>
        <p>
          Standards vary worldwide, but organic farming features practices that
          cycle resources, promote ecological balance, and conserve
          biodiversity.
        </p>
        <p>
          Demand for organic foods is primarily driven by consumer concerns for
          personal health and the environment. Nevertheless, from the
          perspective of science and consumers, there is insufficient evidence
          in the scientific and medical literature to support claims that
          organic food is either safer or healthier to eat than conventional
          food.
        </p>
        <p>
          While there may be some differences in the nutrient and antinutrient
          contents of organically and conventionally produced food, the variable
          nature of food production, shipping, storage, and handling makes it
          difficult to generalize results. Claims that "organic food tastes
          better" are generally not supported by tests.
        </p>
      </div>
